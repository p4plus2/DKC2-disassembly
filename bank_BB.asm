	NOP				;$BB8000	 |
	JMP CODE_BB8E2A			;$BB8001	/

	NOP				;$BB8004	 |
	JMP CODE_BB8E96			;$BB8005	/

	NOP				;$BB8008	 |
	JMP CODE_BB8EB4			;$BB8009	/

	NOP				;$BB800C	 |
	JMP CODE_BB8EEB			;$BB800D	/

	NOP				;$BB8010	 |
	JMP CODE_BB8F26			;$BB8011	/

	NOP				;$BB8014	 |
	JMP CODE_BB8F53			;$BB8015	/

	NOP				;$BB8018	 |
	JMP CODE_BB8F80			;$BB8019	/

	NOP				;$BB801C	 |
	JMP CODE_BB8F9C			;$BB801D	/

	NOP				;$BB8020	 |
	JMP CODE_BB8FAE			;$BB8021	/

	NOP				;$BB8024	 |
	JMP CODE_BB8FC0			;$BB8025	/

	NOP				;$BB8028	 |
	JMP CODE_BB8FFF			;$BB8029	/

	NOP				;$BB802C	 |
	JMP CODE_BB9062			;$BB802D	/

	NOP				;$BB8030	 |
	JMP CODE_BB90C9			;$BB8031	/

	NOP				;$BB8034	 |
	JMP CODE_BB9138			;$BB8035	/

	NOP				;$BB8038	 |
	JMP CODE_BB9150			;$BB8039	/

	NOP				;$BB803C	 |
	JMP CODE_BB9176			;$BB803D	/

	JMP CODE_BB8E6F			;$BB8040	/

	NOP				;$BB8043	 |
	JMP CODE_BB8EAA			;$BB8044	/

	NOP				;$BB8047	 |
	JMP CODE_BB8EDB			;$BB8048	/

	NOP				;$BB804B	 |
	JMP CODE_BB8F01			;$BB804C	/

	NOP				;$BB804F	 |
	JMP CODE_BB8F3B			;$BB8050	/

	NOP				;$BB8053	 |
	JMP CODE_BB8F68			;$BB8054	/

	NOP				;$BB8057	 |
	JMP CODE_BB8F8E			;$BB8058	/

	NOP				;$BB805B	 |
	JMP CODE_BB8FA5			;$BB805C	/

	NOP				;$BB805F	 |
	JMP CODE_BB8FB7			;$BB8060	/

	NOP				;$BB8063	 |
	JMP CODE_BB8FDE			;$BB8064	/

	NOP				;$BB8067	 |
	JMP CODE_BB9029			;$BB8068	/

	NOP				;$BB806B	 |
	JMP CODE_BB9097			;$BB806C	/

	NOP				;$BB806F	 |
	JMP CODE_BB90F2			;$BB8070	/

	NOP				;$BB8073	 |
	JMP CODE_BB9144			;$BB8074	/

	NOP				;$BB8077	 |
	JMP CODE_BB9163			;$BB8078	/

	NOP				;$BB807B	 |
	JMP CODE_BB9190			;$BB807C	/
...
CODE_BB8E32:				;		 |
	...
	INX				;$BB8E38	 |
	DEC $3C				;$BB8E39	 |
	BNE CODE_BB8E32			;$BB8E3B	 |
	JMP CODE_BB8E02			;$BB8E3D	/
...
CODE_BB8E7C:				;		 |
	...
	INX				;$BB8E8E	 |
	DEC $3C				;$BB8E8F	 |
	BNE CODE_BB8E7C			;$BB8E91	 |
	JMP CODE_BB8E10			;$BB8E93	/
...
CODE_BB8EF6:				;		 |
	...
	INX				;$BB8EF9	 |
	DEC $3C				;$BB8EFA	 |
	BNE CODE_BB8EF6			;$BB8EFC	 |
	JMP CODE_BB8E02			;$BB8EFE	/
...
CODE_BB8F1B:				;		 |
	...
	INX				;$BB8F1E	 |
	DEC $3C				;$BB8F1F	 |
	BNE CODE_BB8F1B			;$BB8F21	 |
	JMP CODE_BB8E1D			;$BB8F23	/
...
CODE_BB8F30:				;		 |
	...
	INX				;$BB8F33	 |
	DEC $3C				;$BB8F34	 |
	BNE CODE_BB8F30			;$BB8F36	 |
	JMP CODE_BB8E02			;$BB8F38	/
...
CODE_BB8F48:				;		 |
	...
	INX				;$BB8F4B	 |
	DEC $3C				;$BB8F4C	 |
	BNE CODE_BB8F48			;$BB8F4E	 |
	JMP CODE_BB8E1D			;$BB8F50	/
...
CODE_BB8F5D:				;		 |
	...
	INX				;$BB8F60	 |
	DEC $3C				;$BB8F61	 |
	BNE CODE_BB8F5D			;$BB8F63	 |
	JMP CODE_BB8E02			;$BB8F65	/
...
CODE_BB8F75:				;		 |
	...
	INX				;$BB8F78	 |
	DEC $3C				;$BB8F79	 |
	BNE CODE_BB8F75			;$BB8F7B	 |
	JMP CODE_BB8E1D			;$BB8F7D	/
...
CODE_BB8F8E:
	...
	INX				;$BB8F96	 |
	SEP #$20			;$BB8F97	 |
	JMP CODE_BB8E02			;$BB8F99	/

CODE_BB8F9C:
	LDA $56				;$BB8F9C	\
	STA $0000,x			;$BB8F9E	 |
	INX				;$BB8FA1	 |
	JMP CODE_BB8E10			;$BB8FA2	/

CODE_BB8FA5:
	LDA $56				;$BB8FA5	\
	STA $0000,x			;$BB8FA7	 |
	INX				;$BB8FAA	 |
	JMP CODE_BB8E02			;$BB8FAB	/

CODE_BB8FAE:
	LDA $57				;$BB8FAE	\
	STA $0000,x			;$BB8FB0	 |
	INX				;$BB8FB3	 |
	JMP CODE_BB8E10			;$BB8FB4	/

CODE_BB8FB7:
	LDA $57				;$BB8FB7	\
	STA $0000,x			;$BB8FB9	 |
	INX				;$BB8FBC	 |
	JMP CODE_BB8E02			;$BB8FBD	/
...
CODE_BB9019:				;		 |
	...
	INX				;$BB9020	 |
	DEC $3C				;$BB9021	 |
	BNE CODE_BB9019			;$BB9023	 |
	PLY				;$BB9025	 |
	JMP CODE_BB8E02			;$BB9026	/
...
CODE_BB9052:				;		 |
	...
	INX				;$BB9059	 |
	DEC $3C				;$BB905A	 |
	BNE CODE_BB9052			;$BB905C	 |
	PLY				;$BB905E	 |
	JMP CODE_BB8E1D			;$BB905F	/
...
CODE_BB9087:				;		 |
	...
	INX				;$BB908E	 |
	DEC $3C				;$BB908F	 |
	BNE CODE_BB9087			;$BB9091	 |
	PLY				;$BB9093	 |
	JMP CODE_BB8E10			;$BB9094	/
...
CODE_BB90B9:				;		 |
	...
	INX				;$BB90C0	 |
	DEC $3C				;$BB90C1	 |
	BNE CODE_BB90B9			;$BB90C3	 |
	PLY				;$BB90C5	 |
	JMP CODE_BB8E02			;$BB90C6	/
...
CODE_BB90E2:				;		 |
	...
	INX				;$BB90E9	 |
	DEC $3C				;$BB90EA	 |
	BNE CODE_BB90E2			;$BB90EC	 |
	PLY				;$BB90EE	 |
	JMP CODE_BB8E02			;$BB90EF	/
...
CODE_BB9128:				;		 |
	...
	INX				;$BB912F	 |
	DEC $3C				;$BB9130	 |
	BNE CODE_BB9128			;$BB9132	 |
	PLY				;$BB9134	 |
	JMP CODE_BB8E1D			;$BB9135	/
