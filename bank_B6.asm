...
DATA_B6AE87:
	db $26, $00, $6E, $02, $6D, $01, $73, $AE
	db $27, $00, $00, $40, $26, $00, $04, $02
	db $6D, $01, $73, $AE, $27, $00, $00, $00
	db $26, $00, $D0, $01, $D8, $01, $73, $AE
	db $26, $00, $B6, $02, $D8, $01, $73, $AE
	db $27, $00, $00, $40, $26, $00, $B6, $02
	db $40, $02, $73, $AE, $26, $00, $D0, $01
	db $40, $02, $73, $AE, $27, $00, $00, $00
	db $26, $00, $D0, $01, $A8, $02, $73, $AE
	db $26, $00, $B6, $02, $A8, $02, $73, $AE
	db $27, $00, $00, $40, $26, $00, $74, $02
	db $CD, $02, $73, $AE, $26, $00, $04, $02
	db $CD, $02, $73, $AE, $27, $00, $00, $00
	db $26, $00, $D0, $01, $A8, $02, $73, $AE
	db $26, $00, $B6, $02, $A8, $02, $73, $AE
	db $27, $00, $00, $40, $26, $00, $B6, $02
	db $40, $02, $73, $AE, $26, $00, $D0, $01
...
CODE_B6CB36:
	...
	STA $2E,x			;$B6CB4B	 |
	LDA #$0203			;$B6CB4D	 |
	JSL CODE_B9D0C6			;$B6CB50	 |
	LDA $42,x			;$B6CB54	 |
	PHX				;$B6CB56	 |
	STA $64				;$B6CB57	 |
	LDA #$0206			;$B6CB59	 |
	JSL CODE_B9D0C6			;$B6CB5C	 |
	PLX				;$B6CB60	 |
	STX $64				;$B6CB61	 |
	PLY				;$B6CB63	 |
	RTS				;$B6CB64	/
...
CODE_B6D329:				;		 |
	...
	LDA #$0210			;$B6D339	 |
	JSL CODE_B9D0C6			;$B6D33C	 |
	LDA.l $000656			;$B6D340	 |
	BEQ CODE_B6D2F4			;$B6D344	 |
	STA $64				;$B6D346	 |
	LDA #$0211			;$B6D348	 |
	JSL CODE_B9D0C6			;$B6D34B	 |
	LDA.l $000654			;$B6D34F	 |
	STA $64				;$B6D353	 |
...
CODE_B6DAD6:
	...
	STX $64				;$B6DAEA	 |
	LDA #$0213			;$B6DAEC	 |
	JSL CODE_B9D0C6			;$B6DAEF	 |
	PLX				;$B6DAF3	 |
	STX $64				;$B6DAF4	 |
	LDA #$0212			;$B6DAF6	 |
	JSL CODE_B9D0C6			;$B6DAF9	 |
	LDX $64				;$B6DAFD	 |
	LDA.l $000652			;$B6DAFF	 |
	LDY $06E9			;$B6DB03	 |
...
CODE_B6DBFC:
	...
	STY $64				;$B6DC02	 |
	LDA #$0216			;$B6DC04	 |
	JSL CODE_B9D0C6			;$B6DC07	 |
	PLX				;$B6DC0B	 |
	STX $64				;$B6DC0C	 |
CODE_B6DC0E:				;		 |
	LDA #$0215			;$B6DC0E	 |
	JSL CODE_B9D0C6			;$B6DC11	 |
	LDX $64				;$B6DC15	 |
	LDA $2E,x			;$B6DC17	 |
	ORA #$0008			;$B6DC19	 |
	STA $2E,x			;$B6DC1C	 |
...
CODE_B6DC58:				;		 |
	...
	LDA #$021A			;$B6DC5E	 |
	JSL CODE_B9D0C6			;$B6DC61	 |
	BRA CODE_B6DC6E			;$B6DC65	/

CODE_B6DC67:
	LDA #$0210			;$B6DC67	\
	JSL CODE_B9D0C6			;$B6DC6A	 |
CODE_B6DC6E:				;		 |
	PHB				;$B6DC6E	 |
	LDA #$4000			;$B6DC6F	 |
	ASL A				;$B6DC72	 |
...
CODE_B6F2F5:				;		 |
	...
	STZ $1E,x			;$B6F308	 |
	LDA #$0200			;$B6F30A	 |
	JSL CODE_B9D0C6			;$B6F30D	 |
	LDX $0656			;$B6F311	 |
	STX $64				;$B6F314	 |
	STZ $1E,x			;$B6F316	 |
	LDA #$0204			;$B6F318	 |
	JSL CODE_B9D0C6			;$B6F31B	 |
	PLY				;$B6F31F	 |
	PLX				;$B6F320	 |
	STX $64				;$B6F321	 |
	STZ $44,x			;$B6F323	 |
...
CODE_B6F8A4:				;		 |
	...
	STZ $1E,x			;$B6F8A6	 |
	LDA #$0207			;$B6F8A8	 |
	JSL CODE_B9D0C6			;$B6F8AB	 |
	LDX $0656			;$B6F8AF	 |
	STX $64				;$B6F8B2	 |
	STZ $1E,x			;$B6F8B4	 |
	LDA #$0208			;$B6F8B6	 |
	JSL CODE_B9D0C6			;$B6F8B9	 |
	LDX $0654			;$B6F8BD	 |
	STX $64				;$B6F8C0	 |
...
CODE_B6F904:
	...
	STX $64				;$B6F91E	 |
	LDA #$020B			;$B6F920	 |
	JSL CODE_B9D0C6			;$B6F923	 |
	PLX				;$B6F927	 |
	STX $64				;$B6F928	 |
	LDA #$020C			;$B6F92A	 |
	JSL CODE_B9D0C6			;$B6F92D	 |
	RTL				;$B6F931	/
